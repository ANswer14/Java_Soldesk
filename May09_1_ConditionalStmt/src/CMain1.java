...
public class CMain1 {
	...
	public static int getKoreanTestScore() {
//		Scanner k = new Scanner(System.in);
		System.out.print("국어 점수 : ");
//		int koreanTestScore = k.nextInt();
		int koreanTestScore = new Scanner(System.in).nextInt();
		// 점수에는 - 점수가 없기 때문에
//		return koreanTestScore >= 0 && koreanTestScore <= 100 ?
//				koreanTestScore : getKoreanTestScore();
		return koreanTestScore >= 0 && koreanTestScore <= 100 ?
				koreanTestScore : getKoreanTestScore();
	}
...
//	 }else if (조건 B) {
//		 조건 A (X), 조건B (O)일때 이 부분이 실행
//	 }else if (조건 C) {
//		 조건 A (X), 조건B (X), 조건 C (O)일때 이 부분이 실행
//	 }else {
