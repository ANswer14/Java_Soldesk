...
// 데이터는 사용자로부터 키보드를 통해서 입력될 수 도 있고
// 					   (Scanner의 System.in)
// 파일.네트워크에서도 입력될 수 있다 (???) => (Input)

// 반대로 데이터는 모니터를 통해서 출력될 수 도 있고, 
//			 	(System.out.println)
...
//			OuputStreamWriter : 2byte씩 + 디코딩방식
//			BufferedWriter : 1 line

// 		개조형 (특수목적에 맞게)
//			PrntStream (OutputStream 개조) - 쓰기 편하게 유용한 메소드들 추가
...
public class FileWriteMain {
	public static void main(String[] args) {
		...
		// Linux의 경로 : C:/Users/sdedu/Desktop/Test/beaver1.txt
		//		=> /로 경로 설정
		// Windows의 경로 : C:\\Users\\sdedu\\Desktop\\Test\\beaver1.txt
		// 		=> \\로 경로 설정 + / 하나로도 가능 !
		// Java의 \는 : \t, \r, \n, \0, ... (이스케이프 문자) 에 사용
		// 권한, 폴더명 오타, ... => 예외처리!
		...
		try {
			...
			FileWriter fw = new FileWriter("C:\\Users\\sdedu\\Desktop\\Test\\beaver1.txt", true);
