...
public class TextMain {
	public static void main(String[] args) {
		...
		String s3 = String.format("무게 : %.2fkg\n", 123.456789);
		System.out.println(s3);
		System.out.println("------------------------");
		
		// s2에 글자를 추가
		s2 = s2 + " 올해에는 모두 다 잘 됐으면 좋겟어요 !";
...
//		System.out.println(sb.getClass());
		...
		System.out.println(s5Ar[2]);
		System.out.println(s5Ar[1]);
		System.out.println("------------------------");
		
		// 2. StringTokenizer
		String s6 = "김비버,박비버,최비버,저스틴비버";
		StringTokenizer st = new StringTokenizer(s6, ",");	// 순서대로 나옴
