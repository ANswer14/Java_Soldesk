...
public class VMain1 {
	public static void main(String[] args) {
		// 컴퓨터의 장치 !!
		// CPU / RAM / HDD(하드디스크) / GPU(그래픽카드)
		
		// CPU : 연산장치   ex) (Intel : i5-xxxx, i7-xxxx, / AMD : RyzenX)
		...
		// 3. 자바문법(예약어) 사용하면 에러!
		// int int = 3; (x)
		//int _int =3; (o)//하이픈 써서 에러를 방지하는 방법!
		
		// Java 문화)
		// 4. 변수명을 봐도 뭔지 알 수 있게!
		//int asodifujewalirj = 2;
		//int age = 2;
		...
		// <자료형>
		//    Bit : 데이터를 나타내는 최소 단위 (8bits = 1byte),(1024byte = 1Kbyte)... 이후도 1024기준
		//        Binary Digit(이진수)
		...
		// ●기본형
		//    -정수             
		//        1. byte : -128 ~ 127        바이트의 맨 처음 비트 : 부호비트  -> 0 : 양수 / 1 : 음수
		//        2. short : 약 -3만 ~ 3만
		//        3. int : 약 -21억 ~ 21억 (v)
		//        4. long : int를 벗어나는 범위
		//    -실수
		...
		//     -문자열
		//         1. String : 문자열(여러글자)를 저장, 앞에 대문자 S!
		
		// char vs String
	    //char c = 'z'; // 한 글자를 담는 char /작은 따옴표 사용!
	    //String s = "zzzzzzzzzz";
